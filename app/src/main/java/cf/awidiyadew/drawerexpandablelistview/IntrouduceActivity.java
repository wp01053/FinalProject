...
public class IntrouduceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebView mWebView = (WebView) findViewById(R.id.webView4);
        ...
        mWebView.loadUrl("http://192.168.0.112:8081/spring/AcademyIntro?name="+academy_name);
        mWebView.setWebViewClient(new WebViewClientClaqss());
    }

    private class WebViewClientClaqss extends WebViewClient {
