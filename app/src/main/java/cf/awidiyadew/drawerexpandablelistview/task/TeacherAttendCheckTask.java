...
public class TeacherAttendCheckTask extends AsyncTask<Map<String, String>, Integer, String> {
    ...
    protected String doInBackground(Map<String, String>... maps) { // 내가 전송하고 싶은 파라미터
        ...
        HttpClient.Builder http = new HttpClient.Builder
                ...
                ("POST", "http://" + TaskServer.ip + ":8081/spring/TeacherAttendCheck"); //포트번호,서블릿주소
