...
public class LoginDataTask extends AsyncTask<Map<String, String>, Integer, String> {


//    public static String ip = "192.168.0.104"; // IP주소를 쓰시면 됩니다.
    ...
    protected String doInBackground(Map<String, String>... maps) { // 내가 전송하고 싶은 파라미터
        ...
        HttpClient.Builder http = new HttpClient.Builder
                ...
                ("POST", "http://" + TaskServer.ip + ":8081/spring/userData"); //포트번호,서블릿주소
